...
--
-- Name: band_venue; Type: TABLE; Schema: public; Owner: Guest; Tablespace: 
--
...
ALTER TABLE band_venue OWNER TO "Guest";

--
-- Name: band_venue_id_seq; Type: SEQUENCE; Schema: public; Owner: Guest
--
...
ALTER TABLE band_venue_id_seq OWNER TO "Guest";

--
-- Name: band_venue_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: Guest
--
...
--
-- Name: band_venue_pkey; Type: CONSTRAINT; Schema: public; Owner: Guest; Tablespace: 
--
